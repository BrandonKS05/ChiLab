...
async def interpret_semantic_sanity(
    ...
    *,
    ...
    user_prompt = (
        ...
        "not the whole sentence and not symbols like \\mathbb{N}. "
        "If there are multiple wrong parts (e.g. 'b ≤ a' and 'a - b = b - a'), use one item per part with a short latex_excerpt each.\n\n"
